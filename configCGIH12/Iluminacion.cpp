...
glm::vec3 light2Pos(0.5f, 0.5f, 2.5f);
float movelightPos = 0.0f;
float movelight2Pos = 0.0f;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // Set lights properties - paso 1 
        //paso 4 cargo el perrito con textura y la luz
        ...
        // Set material properties - paso 2 - correr hasta aqui - carga sin efecto luz porque no tienen valores
        //corrida 2 - jugando con los valores   
