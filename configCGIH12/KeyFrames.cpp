...
void saveFrame(void)
{
	...
	KeyFrame[FrameIndex].dogPosX = dogPosX; //posicion de la estructura 
...
void resetElements(void) //al iniciar la anim va al frame inicial
{
...
void KeyCallback(GLFWwindow *window, int key, int scancode, int action, int mode)
{
	...
	if (keys[GLFW_KEY_L])
	{
		if (play == false && (FrameIndex > 1)) //checa sea mayor a 1  
		{
