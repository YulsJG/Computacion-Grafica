...
int main()
{
	...
	Model Dog((char*)"Models/ball.obj");  //cargando modelo balll - 4
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		// Directional light - paso 1 dar valores, ilumina todo el escenario
		...
		//cambiando color - 2 (4ta linea 1 0 0)
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 0.0f, 0.0f, 5.0f); 
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].ambient"), 0.0f, 0.1f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].diffuse"), 0.0f, 1.0f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].specular"), 1.0f, 0.0f, 0.0f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].ambient"), 0.0f, 0.0f, 0.1f);
		...
		// SpotLight - 3, dando valores - configurando las luces
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.position"), camera.GetPosition().x, camera.GetPosition().y, camera.GetPosition().z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.direction"), camera.GetFront().x, camera.GetFront().y, camera.GetFront().z);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.2f, 0.0f, 0.1f);
		...
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.linear"), 0.2f);
		glUniform1f(glGetUniformLocation(lightingShader.Program, "spotLight.quadratic"), 0.4f);
		...
		//habilitando transparencia, 5 - mucho consumo
		model = glm::mat4(1);
